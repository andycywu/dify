...
import { ENABLE_CHAT_CITATION_AND_SUGGESTED_QUESTIONS } from '@/config'
      ...
      <div className='chat-answer-container group ml-4 w-0 grow pb-4' ref={containerRef}>
        <div className={cn('group relative pr-10', chatAnswerContainerInner)}>
          ...
          >
            ...
            {
              ENABLE_CHAT_CITATION_AND_SUGGESTED_QUESTIONS && <SuggestedQuestions item={item} />
            }
            {
              ENABLE_CHAT_CITATION_AND_SUGGESTED_QUESTIONS && !!citation?.length && !responding && (
