...
// Feature flags for chat answer citation and suggested questions
export const ENABLE_CHAT_CITATION_AND_SUGGESTED_QUESTIONS = process.env.NEXT_PUBLIC_ENABLE_CHAT_CITATION_AND_SUGGESTED_QUESTIONS === 'true';
