...
export default function Admin() {
  ...
  const [createData, setCreateData] = useState<CreateUserData>({ email: '', name: '', password: '', role: 'user' });
              ...
              {showCreate && (
                <div className="mb-6 p-4 border rounded bg-gray-50">
                  ...
                  <div className="flex flex-col gap-2">
                    <input className="border rounded px-2 py-1" placeholder="Email" value={createData.email} onChange={e => setCreateData((d: CreateUserData) => ({ ...d, email: e.target.value }))} />
                    <input className="border rounded px-2 py-1" placeholder="姓名" value={createData.name} onChange={e => setCreateData((d: CreateUserData) => ({ ...d, name: e.target.value }))} />
                    <input className="border rounded px-2 py-1" placeholder="密碼" type="password" value={createData.password} onChange={e => setCreateData((d: CreateUserData) => ({ ...d, password: e.target.value }))} />
                    <select className="border rounded px-2 py-1" value={createData.role} onChange={e => setCreateData((d: CreateUserData) => ({ ...d, role: e.target.value }))}>
                    ...
                    {users.map(u => {
                      ...
                      return editing === u.id ? (
                        <tr key={u.id} className="text-center bg-yellow-50">
                          <td className="border px-4 py-2"><input className="border rounded px-2 py-1" value={editData.name} onChange={e => setEditData((d: any) => ({ ...d, name: e.target.value }))} /></td>
                          <td className="border px-4 py-2"><input className="border rounded px-2 py-1" value={editData.email} onChange={e => setEditData((d: any) => ({ ...d, email: e.target.value }))} /></td>
                          <td className="border px-4 py-2"><select className="border rounded px-2 py-1" value={editData.role} onChange={e => setEditData((d: any) => ({ ...d, role: e.target.value }))}><option value="user">user</option><option value="admin">admin</option></select></td>
